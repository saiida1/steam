...
def function(String dockerImageName){
  ...
  stage('Build model') {
    ...
    sh'  (./gradlew jettyRunWar & sleep 10) ; curl -X POST --form pojo=@home/saida/pojos/rf.java --form jar=@home/saida/pojos/h2o-genmodel.jar localhost:55000/makewar > example.war'
      }
  }
